...
WebUI.click(findTestObject('OBJECTawal/STAN_JAKARTA/span_Dikelola Mamikos'))

WebUI.click(findTestObject('OBJECTawal/STAN_JAKARTA/promobtnmengerti'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('OBJECTawal/DikelolaMamikos/span_Kost Apik Rumah Nenek Tipe B Jurangmangu Tangerang Selatan'))
...
WebUI.click(findTestObject('OBJECTawal/Per3bulan/div_Per 3 bulan'))
...
WebUI.click(findTestObject('OBJECTawal/Per3bulan/span_DP_bg-c-radio__icon'))
