...
WebUI.click(findTestObject('OBJECTawal/STAN_JAKARTA/span_Kos Andalan'))

WebUI.click(findTestObject('OBJECTawal/STAN_JAKARTA/input_Hanya menampilkan kos terverifikasi dengan dukungan keamanan dan jaminan dari Mamikos_bg-c-switch__input'))

WebUI.click(findTestObject('OBJECTawal/KosAndalan/span_Kost Bu Pri Pondok Aren Tangerang Selatan RMZ'))
...
WebUI.click(findTestObject('OBJECTawal/oraitkhuswanita'))
