...
WebUI.click(findTestObject('OBJECTawal/STAN_JAKARTA/span_Booking Langsung'))

WebUI.click(findTestObject('OBJECTawal/STAN_JAKARTA/input_Hanya menampilkan kos yang bisa di-booking dan dibayar di Mamikos, tanpa ketemuan dengan pemilik_bg-c-switch__input'))

WebUI.click(findTestObject('OBJECTawal/BokingLangsung/span_Kost Singgahsini DNaraa Bintaro Tangerang Selatan'))
...
WebUI.click(findTestObject('OBJECTawal/Pertahun/Pertahun'))
...
WebUI.click(findTestObject('OBJECTawal/Pertahun/BrpTahun'))
